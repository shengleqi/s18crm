# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-01-27 03:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consultant', to='crm.UserInfo', verbose_name='课程顾问')),
        ...
        migrations.AddField(
            model_name='userinfo',
            name='depart',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='crm.Department', verbose_name='部门'),
        ),
    ]
