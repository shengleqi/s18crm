    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('openid', models.CharField(blank=True, max_length=64, null=True, verbose_name='微信唯一ID')),
        ...
        migrations.AddField(
            model_name='salerank',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.UserInfo'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cds', to='crm.UserInfo', verbose_name='客户顾问'),
        ),
        migrations.AddField(
            model_name='customer',
            name='consultant',
