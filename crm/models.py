...
class ClassList(models.Model):
    ...
    teachers = models.ManyToManyField(verbose_name='任课老师', to='UserInfo', related_name='teach_classes',limit_choices_to={'depart__title':'教学部'})
...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', related_name='consultant',limit_choices_to={'depart__title':"销售部"})
    ...
    # 15天未成单(当前时间-15 > 接客时间)，3天未跟进(当前时间-3天>最后跟进日期)
